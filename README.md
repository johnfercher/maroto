...
## The branch `master` is currently closed for development. The version `v1.0.0` mark the end of maroto V1. Please refer to https://maroto.tech/ to know more about `v2.0.0`.

### V2 Migration roadmap
- [x] [V2 specifications and docs](https://maroto.tech/#/README)
