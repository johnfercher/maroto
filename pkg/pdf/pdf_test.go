	...
	cases := []struct {
	...
	}{
		{
			...
			func(t *testing.T, text *mocks.Text) {
				...
				text.AssertCalled(t, "Rows", "Text1", internal.Cell{
					X:      0.0,
					Y:      0.0,
					Width:  80.0,
					Height: 0.0,
		...
		},
		{
			...
			func(t *testing.T, text *mocks.Text) {
				text.AssertNumberOfCalls(t, "Rows", 2)
				text.AssertCalled(t, "Rows", "Text2", internal.Cell{
					X:      0.0,
					Y:      0.0,
					Width:  80.0,
					Height: 0.0,
				...
				text.AssertCalled(t, "Rows", "Text3", internal.Cell{
					X:      0.0,
					Y:      5.0,
					Width:  80.0,
					Height: 0.0,
		...
		},
		{
			...
			func(t *testing.T, text *mocks.Text) {
				text.AssertNumberOfCalls(t, "Rows", 2)
				text.AssertCalled(t, "Rows", "Text4", internal.Cell{
					X:      0.0,
					Y:      0.0,
					Width:  80.0,
					Height: 0.0,
				...
				text.AssertCalled(t, "Rows", "Text5", internal.Cell{
					X:      80.0,
					Y:      4.4,
					Width:  80.0,
					Height: 0.0,
		...
		},
		{
			...
			func(t *testing.T, text *mocks.Text) {
				text.AssertNumberOfCalls(t, "Rows", 2)
				text.AssertCalled(t, "Rows", "Text6", internal.Cell{
					X:      0.0,
					Y:      0.0,
					Width:  80.0,
					Height: 0.0,
				...
				text.AssertCalled(t, "Rows", "Text7", internal.Cell{
					X:      0.0,
					Y:      40.0,
					Width:  80.0,
					Height: 0.0,
		...
		},
		{
			...
			func(t *testing.T, text *mocks.Text) {
				text.AssertNumberOfCalls(t, "Rows", 1)
				text.AssertCalled(t, "Rows", "Text", internal.Cell{
					X:      10.0,
					Y:      0.0,
					Width:  70.0,
					Height: 0.0,
		...
		},
		{
			...
			func(t *testing.T, text *mocks.Text) {
				text.AssertNumberOfCalls(t, "Rows", 1)
				text.AssertCalled(t, "Rows", "Text8", internal.Cell{
					X:      0.0,
					Y:      40.0,
					Width:  80.0,
					Height: 0.0,
...
func TestFpdfMaroto_ColSpace(t *testing.T) {
	cases := []struct {
		...
		{
			"One ColSpace inside one AddRow",
			func(m pdf.Maroto) {
				m.Row(40.0, func() {
					m.ColSpace(12)
				})
		...
		{
			"Two ColSpace inside one AddRow",
			func(m pdf.Maroto) {
				m.Row(40.0, func() {
					m.ColSpace(5)
					m.ColSpace(7)
