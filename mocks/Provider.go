...
// AddHeatMap provides a mock function with given fields: heatMap, max, cell
func (_m *Provider) AddHeatMap(heatMap [][]int, cell *entity.Cell, prop *props.HeatMap) {
	_m.Called(heatMap, prop, cell)
}

// Provider_AddHeatMap_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'AddHeatMap'
type Provider_AddHeatMap_Call struct {
	*mock.Call
}

// AddHeatMap is a helper method to define mock.On call
//   - heatMap [][]int
//   - max int
//   - cell *entity.Cell
func (_e *Provider_Expecter) AddHeatMap(heatMap interface{}, max interface{}, cell interface{}) *Provider_AddHeatMap_Call {
	return &Provider_AddHeatMap_Call{Call: _e.mock.On("AddHeatMap", heatMap, max, cell)}
}

func (_c *Provider_AddHeatMap_Call) Run(run func(heatMap [][]int, max int, cell *entity.Cell)) *Provider_AddHeatMap_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].([][]int), args[1].(int), args[2].(*entity.Cell))
	})
	return _c
}

func (_c *Provider_AddHeatMap_Call) Return() *Provider_AddHeatMap_Call {
	_c.Call.Return()
	return _c
}

func (_c *Provider_AddHeatMap_Call) RunAndReturn(run func([][]int, int, *entity.Cell)) *Provider_AddHeatMap_Call {
	_c.Run(run)
	return _c
}
