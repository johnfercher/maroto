...
// GetCurrentHeight provides a mock function with given fields:
func (_m *Maroto) GetCurrentHeight() float64 {
	ret := _m.Called()
...
// Maroto_GetCurrentHeight_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetCurrentHeight'
type Maroto_GetCurrentHeight_Call struct {
	*mock.Call
}

// GetCurrentHeight is a helper method to define mock.On call
func (_e *Maroto_Expecter) GetCurrentHeight() *Maroto_GetCurrentHeight_Call {
	return &Maroto_GetCurrentHeight_Call{Call: _e.mock.On("GetCurrentHeight")}
}

func (_c *Maroto_GetCurrentHeight_Call) Run(run func()) *Maroto_GetCurrentHeight_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *Maroto_GetCurrentHeight_Call) Return(_a0 float64) *Maroto_GetCurrentHeight_Call {
	_c.Call.Return(_a0)
	return _c
}
