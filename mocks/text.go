...
func (_m *Text) Add(text string, fontFamily maroto.Family, fontStyle maroto.Style, fontSize float64, marginTop float64, align maroto.HorizontalAlign, actualCol float64, qtdCols float64) {
