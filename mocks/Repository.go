...
func (_m *Repository) ReadTemplate(templateName string) (string, error) {
...
func (_c *Repository_ReadTemplate_Call) Return(_a0 string, _a1 error) *Repository_ReadTemplate_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Repository_ReadTemplate_Call) RunAndReturn(run func(string) (string, error)) *Repository_ReadTemplate_Call {
	_c.Call.Return(run)
	return _c
}

// RegisterTemplate provides a mock function with given fields: name, template
func (_m *Repository) RegisterTemplate(name string, template string) error {
...
//   - name string
//   - template string
func (_e *Repository_Expecter) RegisterTemplate(name interface{}, template interface{}) *Repository_RegisterTemplate_Call {
	return &Repository_RegisterTemplate_Call{Call: _e.mock.On("RegisterTemplate", name, template)}
}
...
func (_c *Repository_RegisterTemplate_Call) RunAndReturn(run func(string, string) error) *Repository_RegisterTemplate_Call {
	_c.Call.Return(run)
	return _c
}
