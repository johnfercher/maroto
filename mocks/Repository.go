...
func (_m *Repository) AddUTF8Font(family string, style fontstyle.Type, file string) fontrepository.Repository {
	...
	var r0 fontrepository.Repository
	if rf, ok := ret.Get(0).(func(string, fontstyle.Type, string) fontrepository.Repository); ok {
		r0 = rf(family, style, file)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(fontrepository.Repository)
		}
	}
...
func (_m *Repository) AddUTF8FontFromBytes(family string, style fontstyle.Type, bytes []byte) fontrepository.Repository {
	...
	var r0 fontrepository.Repository
	if rf, ok := ret.Get(0).(func(string, fontstyle.Type, []byte) fontrepository.Repository); ok {
