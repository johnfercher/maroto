...
func main() {
	...
	m.AddUTF8Font("CustomArial", consts.Normal, "docs/assets/fonts/arial-unicode-ms.ttf")
	m.AddUTF8Font("CustomArial", consts.Italic, "docs/assets/fonts/arial-unicode-ms.ttf")
	m.AddUTF8Font("CustomArial", consts.Bold, "docs/assets/fonts/arial-unicode-ms.ttf")
	m.AddUTF8Font("CustomArial", consts.BoldItalic, "docs/assets/fonts/arial-unicode-ms.ttf")
	...
	err := m.OutputFileAndClose("docs/assets/pdf/utfsample.pdf")
	if err != nil {
