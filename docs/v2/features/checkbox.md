...
The Checkbox component renders a square checkbox with an optional label to its right. When `Checked` is true, a checkmark (✓) is drawn inside the box using two lines. This component is useful for forms, questionnaires, and agreements.
