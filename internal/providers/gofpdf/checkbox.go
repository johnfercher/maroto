...
func (c *Checkbox) Add(label string, cell *entity.Cell, prop *props.Checkbox) {
	...
	if prop.Checked {
		...
		// Two line segments: a short stroke from the upper-left going down to
		// the inner low point, then a longer stroke going up to the upper-right.
		c.pdf.Line(x+prop.Size*0.2, y+prop.Size*0.5, x+prop.Size*0.45, y+prop.Size*0.75)
		c.pdf.Line(x+prop.Size*0.45, y+prop.Size*0.75, x+prop.Size*0.85, y+prop.Size*0.25)
	}
