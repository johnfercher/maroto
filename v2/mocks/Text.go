...
func (_c *Text_Add_Call) Run(run func(text string, cell internal.Cell, textProp props.Text)) *Text_Add_Call {
...
func (_c *Text_Add_Call) RunAndReturn(run func(string, internal.Cell, props.Text)) *Text_Add_Call {
	_c.Call.Return(run)
	return _c
}
