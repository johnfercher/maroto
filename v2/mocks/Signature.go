...
func (_c *Signature_AddSpaceFor_Call) Run(run func(label string, cell internal.Cell, textProp props.Text)) *Signature_AddSpaceFor_Call {
...
func (_c *Signature_AddSpaceFor_Call) RunAndReturn(run func(string, internal.Cell, props.Text)) *Signature_AddSpaceFor_Call {
	_c.Call.Return(run)
	return _c
}
